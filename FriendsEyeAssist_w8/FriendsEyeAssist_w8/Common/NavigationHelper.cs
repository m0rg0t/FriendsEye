...
namespace FriendsEyeAssist_w8.Common
{
    /// <summary>
    ...
    /// ярлыки, используемые для перехода назад и вперед.  Кроме того, средство включает SuspensionManger
    /// для организации управления жизненным циклом процессов и управления состояниями при осуществлении навигации между
    /// страницы.
    /// </summary>
    /// <example>
    /// Чтобы воспользоваться NavigationManager, выполните эти два шага или
    /// начать с BasicPage или любого другого шаблона элементов страниц, отличного от BlankPage.
    /// 
    /// 1) Создание экземпляра NaivgationHelper в любом месте, например в 
    ...
    /// </code>
    /// 
    /// 2) регистрация страницы для вызова в NavigationManager всякий раз, когда участвует страница
