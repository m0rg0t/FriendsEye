...
using FriendsEyeAssists.Controls;
...
namespace FriendsEyeAssists.Pages
{
    public partial class MapPage : PhoneApplicationPage
    {
        ...
        private void DrawMapMarkers()
        {
            ...
            if (ViewModelLocator.MainStatic.CurrentPhotoItems.Count()>0)
            {
                foreach (var item in ViewModelLocator.MainStatic.CurrentPhotoItems)
                {
            ...
            PlaceMap.Center = ViewModelLocator.MainStatic.CurrentPhotoItems.FirstOrDefault().Position;
        }
        ...
        {
            try {
                ViewModelLocator.MainStatic.CurrentItem = ViewModelLocator.MainStatic.CurrentPhotoItems.FirstOrDefault(c=>c.ObjectId==(sender as MapItemControl).Tag.ToString());
